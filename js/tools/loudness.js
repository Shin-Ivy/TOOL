...
const LoudnessMatch = (() => {
  ...
  function mountUI(panel) {
    filePicker = RetroFileInput.create({
      ...
      accept: 'audio/*,.mp3,.wav,audio/mpeg,audio/wav,audio/wave',
      ariaLabel: 'Upload audio for loudness analysis',
      variant: 'blue',
      ...
      <div style="display:flex;gap:16px;flex-wrap:wrap;margin-top:16px;">
        <div style="flex:1;min-width:260px;">
          <div class="px-box" style="border-color:var(--blue);">
            ...
            <div id="loud-meta" style="font-family:var(--font-vt);font-size:16px;color:var(--gray-light);margin-top:8px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">NO TRACK</div>
          </div>
